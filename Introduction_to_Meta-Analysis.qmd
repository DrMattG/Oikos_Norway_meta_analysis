...
## Standardizing Predictors or Outcomes
...
## Standardizing Regression Coefficients ($\beta$)

-   Standardization makes coefficients comparable across studies
...
-   This violates the assumption &rarr; misleading asymmetry or overdispersion
