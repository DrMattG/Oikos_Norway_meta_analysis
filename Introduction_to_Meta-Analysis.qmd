...
*Interpretation:*
On average, true effect sizes vary by ~0.11 around the average effect size.
...
*Interpretation:*
A very high I² (86%) means most of the variation is likely due to actual differences in study context (e.g., species, location, design) — not just sampling error.

## Ratio of Total to Sampling Variability
**H² = 7.09**
This tells you how much bigger the total variability is compared to what you’d expect from sampling error alone.

*Interpretation:*
The observed variability in effect sizes is about 7 times larger than what we’d expect if all studies were estimating the same true effect size.
...
*Interpretation:*
Since the p-value is very small (< 0.0001), we reject the null hypothesis of homogeneity.There is significant heterogeneity — studies are not all estimating the same effect.
